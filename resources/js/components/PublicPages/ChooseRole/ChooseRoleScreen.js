                ...
                <div onChange={onChangeValue} className='gridContainer'>
                    <Grid container>
                        <Grid item xs={6} className='radioContainer'>
                            <input type='radio' className='radio radioGiver' name="role" value="1" />
                            <p className='roleText'>Generous <br /> Patron</p>
                        </Grid>
                        <Grid item xs={6} className='radioContainer'>
                            <input type='radio' className='radio radioTaker' name="role" value="0" />
                            <p className='roleText'>Generous <br /> Implementer</p>
                        </Grid>
                    </Grid>
                </div>
                <div>
