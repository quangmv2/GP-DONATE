...
import { Link, Page, Input, Block, List, Row, ListItem} from 'framework7-react';
import './SignUp.scss';
    ...
    render() {
      return(
          <Page>
              ...
              <p className='bottomText'>Already onboard? <Link href='/'><p className='bottomLink'>Sign In</p></Link></p>
