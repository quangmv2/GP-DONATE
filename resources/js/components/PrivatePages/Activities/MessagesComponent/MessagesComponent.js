                    ...
                    <div className='message-preview-container' onClick={() => props.openWindow(user.id === userInfo.id ? user_to : user,)}>
                        <div className='message-component-container'>
                            <div style={{ position: "relative" }}>
                                {
                                    user.id === userInfo.id && user_to.code_id ? <StarFilled className="icon-star" style={{ fontSize: "15px" }} /> : <></>
                                }
                                {
                                    user.id !== userInfo.id && user.code_id ? <StarFilled className="icon-star" style={{ fontSize: "15px" }} /> : <></>
                                }
                                {
