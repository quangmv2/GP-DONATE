...
<div class="card">
    <div class="card-body">
        ...
        {!! Form::model($module, ['id'=>'form_menu', 'method' => 'PATCH','route' => ['menus.update', $module->id]]) !!}
        {{ Form::hidden('menus', $menu ? $menu->content : '', array('class' => 'form-control hide', 'id' => 'menus')) }}
        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <ol id="nestedMenu" class="custom-list list-group col nested-sortable dd">
                                @if($menu)
                                    @php
                                        $menus_decode = json_decode($menu->content);
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <button type="button" class="btn btn-primary btn-submit-menu">Submit</button>
            </div>
        </div>
        {!! Form::close() !!}
    </div>
