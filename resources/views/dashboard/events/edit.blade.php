            ...
            <div class="row">
                     ...
                     <div class="row">
            		    <div class="col-xs-12 col-sm-12 col-md-12">
            		        <div class="form-group">
            		            <strong>Title:</strong>
                                {{ Form::text('name', $event->name, array('class' => 'form-control', 'placeholder' => 'Name')) }}
            		        </div>
            		    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-prepend">
                                     ...
                                     {{ Form::text('start_end_date', $start_date.' - '.$end_date , array('class' => 'form-control daterange-basic')) }}
                                </div>
                            </div>
                        </div>
            		    ...
            		    <div class="col-xs-12 col-sm-12 col-md-12">
            		        <div class="form-group">
                                ...
                                {!! Form::textarea('description', $event->description, ['id' => 'description', 'class' => 'form-control','placeholder' => 'Description', 'style' => 'height:150px']) !!}
            		        </div>
            		    </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>Content:</strong>
                                {!! Form::textarea('content', $event->content, ['id' => 'content', 'class' => 'form-control content-editor','placeholder' => 'Content']) !!}
                            </div>
                        </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::hidden('feature_image', $event->feature_image, array('class' => 'form-control hide', 'id' => 'feature_image')) }}
                        <div id="image_preview">
                            @if($event->feature_image || old('feature_image'))
                            <img src="{{old('feature_image') ? old('feature_image') : $event->feature_image}}" /><span class="remove_image icon-cross3 remove" ></span>
                            @endif
                        </div>
                    </div>
