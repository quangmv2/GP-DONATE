        ...
        var _dataTable = $('#table_posts').DataTable( {
            ...
            "columns": [
                ...
                { 
                    ...
                    "orderable": false,
                    "render": function(data, type, row, meta){
                        var htmlAction = "<a class='btn btn-primary mr-2' href='books/"+data+"/edit'>Edit</a>";
                        htmlAction += "<form method='POST' action='books/"+data+"' accept-charset='UTF-8' style='display:inline' class='form_delete'><input name='_method' type='hidden' value='DELETE'><input name='_token' type='hidden' value='"+_csrfToken+"'><input class='btn btn-danger btn_delete_post' type='button' value='Delete'></form>";
