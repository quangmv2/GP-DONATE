                     ...
                     <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>Quote:</strong>
                                {!! Form::textarea('quote', $quote->quote, ['id' => 'quote', 'class' => 'form-control','placeholder' => 'Quote', 'style' => 'height:150px']) !!}
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {{ Form::text('author', $quote->author, array('class' => 'form-control', 'placeholder' => 'Author')) }}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {{ Form::hidden('feature_image', $quote->feature_image, array('class' => 'form-control hide', 'id' => 'feature_image')) }}
                                <div id="image_preview">
                                    @if($quote->feature_image || old('feature_image'))
                                    <img src="{{old('feature_image') ? old('feature_image') : $quote->feature_image}}" /><span class="remove_image icon-cross3 remove" ></span>
                                    @endif
                                </div>
                            </div>
                        </div>
